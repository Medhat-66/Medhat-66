...
|---|---|---|---|
| [Spam Email Detection](https://github.com/Medhat-66/spam-email-detection-nlp) | NLP classifier using BOW, TF-IDF, Word2Vec & Neural Network | Python, NLTK, Keras | 98.36% Accuracy |
| [Used Car Price Prediction](https://github.com/Medhat-66/used-car-price-prediction) | Regression models to predict car selling prices | Python, Scikit-learn, Statsmodels | R² = 0.895 |
| [Loan Eligibility Prediction](https://github.com/Medhat-66/loan-eligibility-prediction) | Binary classification for bank loan approval | Python, Scikit-learn | 84.50% Accuracy |
| [Egypt Internet Usage Analysis](https://github.com/Medhat-66/egypt-internet-usage-analysis) | End-to-end data analysis on 6,000+ records | Python, SQL, Power BI, Excel | 4 Key Insights |
